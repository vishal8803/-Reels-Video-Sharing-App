...
export default function Login() {
  ...
  const handleClick = async()=>{
    ...
    try{
      ...
      setError("The email / password you entered doesn't belong to an account. Please check your email / password and try again.");
      setEmail('')
      setPassword('');
      setLoading(false);
    }
    ...
    <div className='login-body'>
        ...
        <div className='card-wrapper'>
            ...
            <CardContent>
                ...
                <TextField id="outlined-basic1" label="Email" type="email" variant="outlined" fullWidth size='small' margin="dense" value={email} onChange={(e)=>setEmail(e.target.value)} />
                <TextField id="outlined-basic2" label="Password" type="password" variant="outlined" fullWidth size='small' margin="dense" value={password} onChange={(e)=>setPassword(e.target.value)} />
            ...
            <CardActions>
                ...
                <Button size="small" fullWidth variant='contained' onClick={handleClick} disabled={loading}  >Log In</Button>
            </CardActions>
